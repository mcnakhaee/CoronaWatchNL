...
The goal of CoronaWatchNL is to ...

## Installation

You can install the released version of CoronaWatchNL from [CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("CoronaWatchNL")
```
